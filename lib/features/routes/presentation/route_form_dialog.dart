...
class _RouteFormDialogState extends State<RouteFormDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(
        _isEditing ? l10n.t('routes.edit') : l10n.t('routes.add'),
      ),
      content: SizedBox(
        width: 520,
        child: Form(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: _autocompleteField(
                        ...
                        validator: (v) {
                          ...
                          if (!RegExp(r'^[A-Z]{4}$').hasMatch(v.toUpperCase())) {
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        validator: (v) {
                          if (v == null || v.isEmpty) return null;
                          if (!RegExp(r'^[A-Z]{3}$').hasMatch(v.toUpperCase())) {
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (v) => setState(() => _category = v ?? 'internacional'),
                ),
                const SizedBox(height: 16),
                Row(
                  children: [
